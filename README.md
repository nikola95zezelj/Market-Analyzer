...
│ └── AAPL/
│ └── chunks/
│ └── aapl-20250927_item7_chunks.json
│
├── notebooks/
...
- Compare sentiment across years
- Add LLM-based summarization or risk extraction
- Build quantitative signals from textual sentiment
